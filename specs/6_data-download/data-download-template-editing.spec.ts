...
describe('Data Download. Templates - Editing.', function () {
  ...
  it('19.5 -  Can update template with hourly time interval', async function () {
  ...
  it('19.6 -  Can update template with 15min time interval', async function () {
    await Steps.navigationSteps.goToEntityManagement('Reports', 'Data Downloads');
    await Steps.dataDownloadSteps.createNewDataDownloadTemplate({
      client   : TestData.CLIENT,
      portfolio: TestData.PORTFOLIO_NAME,
  ...
  it('19.7 -  Can update template with Daily time interval', async function () {
    await Steps.navigationSteps.goToEntityManagement('Reports', 'Data Downloads');
    await Steps.dataDownloadSteps.createNewDataDownloadTemplate({
      client   : TestData.CLIENT,
      portfolio: TestData.PORTFOLIO_NAME,
  ...
  it('19.8 -  Can update template with Raw time interval', async function () {
    await Steps.navigationSteps.goToEntityManagement('Reports', 'Data Downloads');
    await Steps.dataDownloadSteps.createNewDataDownloadTemplate({
      client   : TestData.CLIENT,
      portfolio: TestData.PORTFOLIO_NAME,
